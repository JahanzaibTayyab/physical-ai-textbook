  ...
  courseSidebar: [
    'intro',
    {
      ...
      items: [
        ...
        'module-1-ros2/python-agents-ros',
    ...
    },
    {
      ...
      items: [
        ...
        'module-2-simulation/urdf-sdf-formats',
    ...
    },
    {
      ...
      items: [
        'additional/introduction-physical-ai',
        'additional/sensor-systems',
        'additional/humanoid-kinematics',
        'additional/conversational-robotics',
      ],
    },
  ],
};
